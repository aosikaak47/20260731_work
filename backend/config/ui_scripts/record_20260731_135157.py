...
async def test_登录录制():
    ...
    try:
        async with async_playwright() as p:
            ...
            click_done = False
            for loc_expr in [
                lambda: page.locator("form > div:nth-of-type(4) > div > div > div"),
                ...
                try:
                    ...
                    continue
            if not click_done:
                await page.locator("form > div:nth-of-type(4) > div > div > div").click(force=True)
            await page.wait_for_timeout(STEP_DELAY)
