...
record_file = r"E:\trae_work\autoProject\backend\app\../config/ui_scripts\record_7c947e50-5cfa-4634-988b-2856eb34ac04.json"
...
async def main():
    try:
        ...
        async with async_playwright() as p:
            ...
            print(f"[Recorder] Page loaded, waiting for user actions...", flush=True)
            save_actions(recorded_actions, "recording")
