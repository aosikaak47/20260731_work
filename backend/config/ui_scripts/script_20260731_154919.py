...
SESSION_ID = '6969e37a-e9d9-4200-aec3-94a3c78e6506'
...
async def run_test():
    try:
        async with async_playwright() as p:
            ...
            await page.screenshot(path="E:/trae_work/autoProject/backend/config/ui_results/result_20260731_154919/test_result.png")
            await browser.close()
    except Exception as e:
