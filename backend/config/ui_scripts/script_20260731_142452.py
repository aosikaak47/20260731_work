...
SESSION_ID = 'bce2842d-3d91-4516-9ebb-f168631c1ae1'
...
async def run_test():
    try:
        async with async_playwright() as p:
            ...
            await page.screenshot(path="E:/trae_work/autoProject/backend/config/ui_results/result_20260731_142452/test_result.png")
            await browser.close()
    except Exception as e:
