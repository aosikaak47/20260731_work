...
SESSION_ID = '9d43bd93-7a18-4128-bc8b-8c82f7ef2875'
...
async def run_test():
    try:
        async with async_playwright() as p:
            ...
            await page.screenshot(path="E:\trae_work\autoProject\backend\app\../config/ui_results\result_20260731_113749/test_result.png")
            await browser.close()
    except Exception as e:
