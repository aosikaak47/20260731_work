...
generate_data = json.dumps({
    'case': {
        ...
        'steps': [
            ...
            {'type': 'input', 'name': '输入搜索词', 'element': '搜索框', 'params': {'value': 'Playwright'}},
            {'type': 'click', 'name': '点击搜索按钮', 'element': '搜索按钮'},
...
try:
    ...
    print(f"  脚本长度: {len(generated_script)} 字符")
    print(f"  脚本预览 (前500字符):")
